...
(function() {
   ...
   */
  const onn = (type, el, listener, all = false) => {
   ...
   * Mobile nav toggle
   */
  onn('click', '.mobile-nav-toggle', function(e) {
  ...
  window.addEventListener('load', () => {
    ...
    if (portfolioContainer) {
      ...
      onn('click', '#portfolio-flters li', function(e) {
        e.preventDefault();
  ...
  $('#formcontacto').on('submit', function(e) {
    ...
    $.ajax({
      ...
      success: function(response) {
        // Aquí puedes hacer algo con la respuesta del servidor (si hay alguna)
